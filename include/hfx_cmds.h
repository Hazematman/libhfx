...
#define     HFX_STATUS_IN_RDP_RESERVE   0x0002
#define     HFX_STATUS_FIFO_EMPTY       0x0004
...
#define HFX_CMD_BLANK_CMD       0x0003 /* TODO this command is unused and can be replaced */
